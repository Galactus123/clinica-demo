      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-6">
            <span className="inline-block rounded-full bg-cyan-100 px-4 py-1.5 text-sm font-medium text-cyan-700">
              Sobre a Clínica
            </span>
          ...
          <div className="relative">
            <div className="relative h-80 w-full overflow-hidden rounded-2xl shadow-xl sm:h-96">
              <Image
            ...
            <div className="absolute -top-4 -left-4 w-16 h-16 bg-cyan-200/50 rounded-xl -z-10" />
          </div>
        </div>
      </div>
    </section>
