    ...
    <section id="contacto" className="bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100">
                <Icon name="map-pin" size={24} className="text-blue-600" />
              </div>
              <div>
          ...
          <div className="relative flex h-80 items-center justify-center overflow-hidden rounded-2xl bg-gray-100 shadow-sm sm:h-96 lg:h-full lg:min-h-[400px]">
